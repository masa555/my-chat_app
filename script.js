...
let app = new Vue({
  ...
  created: function () {
   ...
   let dummyNameList = ['山田','倉谷','山岡','塚原', '長谷川'];
  ...
  data: {
    ...
    , messageList: []
    , developerSite: "https://twitter.com/gosick2058"
    , qrUrl: ""
    , showedQr: false
  },
  ...
  methods: {
    ...
    setupFirebase: function(){
     var config = {
     apiKey: "AIzaSyDzC8NZ94kRlKcMndBUIVxPB3yaMUXivPE",
    authDomain: "catapp-2f1fa.firebaseapp.com",
    databaseURL: "https://catapp-2f1fa.firebaseio.com",
    projectId: "catapp-2f1fa",
    storageBucket: "catapp-2f1fa.appspot.com",
    messagingSenderId: "772975862665"
  };
